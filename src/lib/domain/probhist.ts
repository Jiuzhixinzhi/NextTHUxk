...
/** 折线 SVG 坐标串（x 按时间比例，跨窗口缺口不失真；<2 点 → null） */
export function sparkPath(series: { t: number; prob: number }[], w: number, h: number, pad = 4): string | null {
